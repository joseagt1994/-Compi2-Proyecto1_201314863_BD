...
package com.jagt.Analizadores;
import com.jagt.AST.*;
import com.jagt.Analisis.ParseException;
import com.jagt.Analisis.SimpleCharStream;
import com.jagt.Analisis.SintacticoConstants;
import com.jagt.Analisis.SintacticoTokenManager;
import com.jagt.Analisis.Token;
public class Sintactico implements SintacticoConstants {
 ...
 NodoParser cuerpos,c;
    ...
    jj_consume_token(0);
         Compilador compi = new Compilador(cuerpos); {if (true) return 0;}
 ...
 NodoParser nodo,tipo; Token id1,id2;
 ...
 NodoParser nodo,lista,d,exps; Token t,id;
    ...
    exps = lista_expresiones();
                                     nodo.hijos().add(new NodoParser(exps));
    jj_consume_token(99);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case RES_DONDE:
      d = donde();
 ...
 NodoParser nodo,s,d,tipo; Token t,id,o;
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case RES_ORDENAR:
      o = jj_consume_token(RES_ORDENAR);
                                     o = new NodoParser("ORDENAR",o.image,o.beginLine,o.beginColumn);
      id = jj_consume_token(ID);
 ...
 NodoParser nodo,lista; Token id;
    id = jj_consume_token(ID);
                                     nodo = new NodoParser("LLAMADA","",0,0); nodo.hijos().add(new NodoParser("ID",id.image,id.beginLine,id.beginColumn));
    jj_consume_token(98);
 ...
 NodoParser nodo,lista,exps; Token t,id;
    ...
    jj_consume_token(RES_EN);
    id = jj_consume_token(ID);
                                     nodo.hijos().add("ID",id.image,id.beginLine,id.beginColumn);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 98:
      jj_consume_token(98);
      lista = lista_ids();
 ...
 NodoParser nodo = new NodoParser("CAMPO","",0,0); NodoParser tip,com; Token id;
    tip = tipo();
                                     nodo.hijos().add(tip);
    id = jj_consume_token(ID);
                                     nodo.hijos().add(new NodoParser("ID",id.image,id.beginLine,id.beginColumn));
 ...
 NodoParser nodo = new NodoParser("COMPLEMENTO","",t.beginLine,t.beginColumn); Token t,id;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case RES_NO:
 ...
 NodoParser nodo = new NodoParser("PARAMETRO","",0,0); NodoParser t; Token v;
    t = tipo();
                         nodo.hijos().add(t);
    v = jj_consume_token(VAR);
                         nodo.hijos().add(v); {if (true) return nodo;}
    throw new Error("Missing return statement in function");
  }
 ...
 NodoParser nodo = new NodoParser("CREAR","",0,0); Token id,cad;
    t = jj_consume_token(RES_USUARIO);
...
//EXP
 ...
 NodoParser nodo,con,sen,sn,sns; Token t;
    ...
    case SINO:
      t = jj_consume_token(SINO);
                                 sn = new NodoParser("SINO","",t.beginLine,t.beginColumn);
      jj_consume_token(101);
                                 sns = new NodoParser("SENTENCIAS","",t.beginLine,t.beginColumn);
      sen = lista_sentencias();
                                   sns.hijos().add(sen);
      jj_consume_token(102);
 ...
 NodoParser nodo,exp,cas,def,sen,sns; Token t;
    ...
    case DEFECTO:
      t = jj_consume_token(DEFECTO);
                             def = new NodoParser("DEFECTO","",t.beginLine,t.beginColumn); sns = new NodoParser("SENTENCIAS","",t.beginLine,t.beginColumn);
 ...
 NodoParser nodo,caso,exp,sns,sen; Token t;
    ...
    exp = expresion();
                         caso.hijos().add(exp); sns = new NodoParser("SENTENCIAS","",t.beginLine,t.beginColumn);
    jj_consume_token(103);
    sen = lista_sentencias();
                               sns.hijos().add(sen);
...
Token t,tp;
    ...
    cre = crecimiento();
                          cre.hijos().addFirst(new NodoParser("ID",tp.image,tp.beginLine,tp.beginColumn)); nodo.hijos().add(cre);
    jj_consume_token(99);
    jj_consume_token(101);
                     sns = new NodoParser("SENTENCIAS","",tp.beginLine,tp.beginColumn);
    sen = lista_sentencias();
                                sns.hijos().add(sen);
    jj_consume_token(102);
                          nodo.hijos().add(sns); {if (true) return nodo;}
    throw new Error("Missing return statement in function");
  }
 ...
 NodoParser nodo,ope,con;
    ...
    con = condicion2();
                         if(con!=null){con.hijos().addFirst(ope); {if (true) return con;}}else{{if (true) return ope;}}
    throw new Error("Missing return statement in function");
  }
 ...
 Token t; NodoParser nodo;
    ...
    case NOT:
      // subcondicion2 -> NULO id
              ...
              t = jj_consume_token(NOT);
                               nodo = new NodoParser("EXP","",t.beginLine,t.beginColumn);
      t = jj_consume_token(ID);
                                nodo.hijos().add(new NodoParser("NOT","!&\u00c2\u00a1",t.beginLine,t.beginColumn)); nodo.hijos().add(new NodoParser("ID",t.image,t.beginLine,t.beginColumn)); {if (true) return nodo;}
      break;
    case ENTERO:
    case DOBLE:
    case CADENA:
  ...
  final public NodoParser subcondicion2() throws ParseException {
 ...
 NodoParser nodo,dim,exp; Token t;
    ...
    case INCREMENTO:
      t = jj_consume_token(INCREMENTO);
                             nodo = new NodoParser("CRECIMIENTO","++",t.beginLine,t.beginColumn); {if (true) return nodo;}
      break;
    case DECREMENTO:
    ...
    case ASIGNA:
      ...
      exp = expresion();
                             nodo = new NodoParser("ASIGNACION","=",t.beginLine,t.beginColumn); nodo.hijos().add(exp); {if (true) return nodo;}
      break;
    default:
      jj_la1[42] = jj_gen;
      jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10400000,0x10400000,0x10000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2f800000,0x0,0x23000000,0x0,0x0,0x2f800000,0x0,0x0,0x0,0x0,0xfc000,0xfc000,0x0,0xfc000,0x0,0x0,0x0,0x303e00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x303e00,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xb230dc63,0xb230dc63,0xa0301c60,0xa0301c60,0xc000000,0x0,0x0,0x0,0x0,0x200,0x200,0x200,0x20000,0x0,0xc0000,0x0,0x0,0x0,0xc,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa0000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x6000001c,0x6000001c,0x6000001c,0x6000001c,0x0,0x80,0x80000,0x0,0x20000400,0x0,0x0,0x0,0x0,0x20000400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3f00000,0x0,0x3f00000,0x0,0x0,0x0,0x0,0x0,0x0,0x300,0xc00,0x20000000,0x18,0x0,0x2,0x1,0x4000000,0x8000000,0x10000000,0x30000000,0x7e000,0x80060,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x10,0x0,0x0,0x10,0x0,0x10,0x0,0x0,0x10,0x0,0x10,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,};
   }
